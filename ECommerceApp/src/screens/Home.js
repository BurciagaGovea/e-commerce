...
const categories = [
  { id: '1', name: 'ROLL', imageUrl: 'https://i.pinimg.com/736x/f6/8c/16/f68c16a0d4ab255746454ee01b0b096d.jpg' },
  { id: '2', name: 'COOKIES', imageUrl: 'https://i.pinimg.com/736x/a3/66/dc/a366dc857b7b7335b8ef269fc549d229.jpg' },
];
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 }}>
        {categories.map(cat => (
          <TouchableOpacity key={cat.id} style={{ width: '48%' }}>
            <Image source={{ uri: cat.imageUrl }} style={{ width: '100%', height: 120, borderRadius: 10 }} />
            <Text style={{
              position: 'absolute',
              bottom: 10,
              left: 10,
